...
// first load with no stored session -- must match apps/dashboard's
// VITE_AUTO_LOGIN_* or the two apps watch different patients. Real
// multi-user login still works normally: log out to reach the login form
// and sign in as anyone else.
